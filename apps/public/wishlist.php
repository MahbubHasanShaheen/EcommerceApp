...
<button class="btn btn-success" style="float: right; margin-top: 50px;  color:white; font-weight: bold;font-size: 16px;" type="submit" name="btn_order">CONFIRM ORDER</button>
</form>
</div>
</div>
