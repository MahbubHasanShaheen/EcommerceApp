...
<a href="<?php appsConfig::URL('logout');?>"><button class="btn btn-success" style="float: left; margin-top: 50px; width:200px; color:brown; font-weight: bold;font-size: 16px;margin-left: 150px; box-shadow: 1px 5px 10px black">CHECKOUT</button></a>
